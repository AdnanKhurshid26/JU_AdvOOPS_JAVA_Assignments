...
public class EmployeeList {
    ...
    public void addEmployee(ArrayList<Department> departments) {
    ...
    public void displayEmployee(ArrayList<Department> departments) {
    ...
    public void displayAllEmployees(ArrayList<Department> departments) {
        for (Employee e : employees) {
            System.out.println("Employee code: " + e.getEmpCode());
            System.out.println("Employee name: " + e.getEmpName());
            System.out.println("Employee basic: " + e.getBasic());
    ...
    public void removeEmployee(ArrayList<Department> departments) {
        System.out.println("Enter the employee code: ");
        String empcode = sc.nextLine();
        for (Employee e : employees) {
            if (e.getEmpCode().equals(empcode)) {
